 ...
 * @see https://v0.dev/t/Lc6qbdM0CQ2
 */
...
export function Garantias() {
  return (
    (<div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
      ...
      <Card>
        <CardHeader className="pb-0">
          <CardTitle className="text-2xl">DEF456</CardTitle>
          <CardDescription>License Plate</CardDescription>
        </CardHeader>
        <CardContent className="pt-0">
          <div className="grid gap-1.5">
            ...
            <div className="flex items-center gap-2 text-sm">
              <div>Valid from:</div>
              <div className="font-medium">2024-03-28</div>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <div>Valid to:</div>
              <div className="font-medium">2029-03-28</div>
            </div>
          </div>
        </CardContent>
        <CardFooter className="flex justify-between">
